...
Now for some trivia: the best starting word is ARISE (or alternately its anagram RAISE).  With ARISE your first guess the largest remaining solution set is 168 words.  No other letter combination matches this.  Next best is ALONE which gurantees a maximum solution set size of 182 words.  The hardest words to solve are ones that have a large number of adjacent solutions.  Take ROVER
